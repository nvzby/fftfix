...
exports.URLs = _.mapValues(exports.ROUTES, val => _.template(val));
exports.WEB_URLs = _.mapValues(exports.WEB_ROUTES, val => _.template(val));
function getUrl(key, data = {}) {
    if (_.isFunction(exports.URLs[key]))
        return constants_1.API_ENDPOINT + exports.URLs[key](data);
    throw new Error(`Url with key "${key}" is not available`);
}
exports.getUrl = getUrl;
function getWebUrl(key, data = {}) {
    if (_.isFunction(exports.WEB_URLs[key]))
        return constants_1.WEBHOST + exports.WEB_URLs[key](data);
