...
class CheckpointError extends APIError {
    ...
    get url() {
        ...
        if (_.isString(json.checkpoint_url))
            return json.checkpoint_url;
        if (_.isObject(json.checkpoint) && _.isString(json.checkpoint.url))
            return json.checkpoint.url;
        if (_.isObject(json.challenge) && _.isString(json.challenge.url))
