...
class Thread extends Resource {
    ...
    parseParams(json) {
        ...
        hash.inviter = class_transformer_1.plainToClass(user_1.User, json.inviter);
        this.items = _.map(json.items, item => new ThreadItem(that.session, item));
        this.accounts = class_transformer_1.plainToClass(user_1.User, json.users);
        this.leftUsers = class_transformer_1.plainToClass(user_1.User, json.left_users);
        return hash;
    }
    getParams() {
