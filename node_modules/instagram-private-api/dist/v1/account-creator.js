...
class AccountCreator {
    ...
    autocomplete(account) {
        ...
        return QE.sync(session)
            .then(() => {
            const autocomplete = Relationship.autocompleteUserList(session).catch(Exceptions.RequestsLimitError, () => false);
...
class AccountPhoneCreator extends AccountCreator {
    ...
    create() {
        ...
        return new core_1.Request(that.session)
            ...
            return class_transformer_1.plainToClass(user_1.User, json.created_user);
        });
    }
}
