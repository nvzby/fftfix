...
class Media extends Resource {
    ...
    static likers(session, mediaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield new request_1.Request(session)
                .setMethod('GET')
    ...
    static configureVideo(session, uploadId, caption, durationms, delay, { audio_muted = false, trim_type = 0, source_type = 'camera', mas_opt_in = 'NOT_PROMPTED', disable_comments = false, filter_type = 0, poster_frame_index = 0, geotag_enabled = false, camera_position = 'unknown', } = {}) {
        if (_.isEmpty(uploadId))
            throw new Error('Upload argument must be upload valid upload id');
        ...
        return Promise.delay(delay)
            ...
            return new request_1.Request(session)
                ...
                .send()
                .then(json => new Media(session, json.media))
                .catch(Exceptions.TranscodeTimeoutError, (error) => Media.configureVideo(session, uploadId, caption, durationms, delay));
        });
    }
